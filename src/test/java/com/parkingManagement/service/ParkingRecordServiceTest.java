...
class ParkingRecordServiceTest {
    ...
    @DisplayName("Создание новой записи о парковке с корректными данными")
    @Test
    ...
    @DisplayName("Создание записи о парковке с некорректными данными (null время въезда)")
    @Test
    ...
    @DisplayName("Получение записи о парковке по существующему идентификатору")
    @Test
    ...
    @DisplayName("Получение записи о парковке по несуществующему идентификатору")
    @Test
